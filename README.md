# DevContainer Odoo 16.0

Entorno de desarrollo reproducible para Odoo 16.0 usando DevContainers y Docker.
...
```
Clona el repo https://github.com/desarrollonextpro/devcontainers-odoo rama 16.0
en ~/odoo-16 y levanta el entorno DevContainer para Odoo 16
```
...
```
/home/ubuntu/
├── odoo-16/    <-- clon de la rama 16.0 (este repo)
...
```bash
git clone -b 16.0 https://github.com/desarrollonextpro/devcontainers-odoo.git ~/odoo-16
cd ~/odoo-16
```
...
Acceder en: http://localhost:7069
...
Este entorno incluye skills de Claude Code para acelerar el desarrollo Odoo 16:

- Patrones de modelos Odoo 16 (attrs, SQL directo, Command class)
- Generador de módulos v16 (attrs={} para vistas, states en botones)
- Componentes OWL 1.x
- Conocimiento de versión 16.0 (breaking changes, novedades)
...
```ini
addons_path = /workspace/enterprise.16.0,/workspace/odoo.16.0/addons,/workspace/custom-addons/mi-addon
```
