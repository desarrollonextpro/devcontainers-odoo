...
2. **Clasifica** cada aprendizaje y decide su destino con esta tabla de routing:
   ...
   | Conocimiento **específico de una versión** de Odoo (API, QUnit vs Hoot, cambios entre versiones…) | Archivo por versión: `/workspace/.claude/knowledge/odoo-*-16.md` (p. ej. `odoo-owl-components-16.md`) |
...
> 1. (por versión) En Odoo 16 las vistas de lista se declaran con `<tree>` (en v17+ pasan a `<list>`)
>    → propongo añadir 1 línea a `/workspace/.claude/knowledge/odoo-version-knowledge-16.md`.
